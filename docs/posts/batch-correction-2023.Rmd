...
txtplot(.delta.db[,1], W.true[,1], width=50, height=30,
        xlab="estimated delta (batch 1)",
        ylab="true delta effect")

txtplot(.delta.db[,2], W.true[,2], width=50, height=30,
...
txtplot(.tsne[,1], .tsne[,2], xlab = "tsne1", ylab = "tsne2", width=50, height=30)

.tsne <- Rtsne::Rtsne(log(1 + t(yy/.delta.db[,batch])), num_threads=4)$Y

txtplot(.tsne[,1], .tsne[,2], xlab = "tsne1 adj", ylab = "tsne2 adj", width=50, height=30)
```
